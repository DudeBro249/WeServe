...
import 'package:provider/provider.dart'; // Imports Flutter material

class ElderlySettingsPage extends StatefulWidget {
  @override
  _ElderlySettingsPageState createState() => _ElderlySettingsPageState();
}

class _ElderlySettingsPageState extends State<ElderlySettingsPage> {
          ...
          actions: <Widget>[
            FlatButton(
              onPressed: () {
                ...
                DatabaseService(uid: user.uid).deleteAllElderlyUserData();
                user.delete();
                Navigator.pop(context);
              },
              color: Colors.green,
